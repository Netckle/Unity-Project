...
public class NewBehaviourScript :EditorWindow
{
    ...
    void OnGUI ()
    {
        var normal = (Font)AssetDatabase.LoadAssetAtPath ("Assets/Fonts/NanumGothicBold.ttf", typeof(Font));
        var small = (Font)AssetDatabase.LoadAssetAtPath ("Assets/Fonts/NanumGothicBold.ttf", typeof(Font));
        var big = (Font)AssetDatabase.LoadAssetAtPath ("Assets/Fonts/NanumGothicBold.ttf", typeof(Font));
        var bold = (Font)AssetDatabase.LoadAssetAtPath ("Assets/Fonts/NanumGothicExtraBold.ttf", typeof(Font));
        var bold_small = (Font)AssetDatabase.LoadAssetAtPath ("Assets/Fonts/NanumGothicExtraBold.ttf", typeof(Font));
