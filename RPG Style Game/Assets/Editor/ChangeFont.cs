...
public class NewBehaviourScript :EditorWindow
{
    ...
    void OnGUI ()
    {
        var normal = (Font)AssetDatabase.LoadAssetAtPath ("Assets/Fonts/NanumBarunGothic.ttf", typeof(Font));
        var small = (Font)AssetDatabase.LoadAssetAtPath ("Assets/Fonts/NanumBarunGothic.ttf", typeof(Font));
        var big = (Font)AssetDatabase.LoadAssetAtPath ("Assets/Fonts/NanumBarunGothic.ttf", typeof(Font));
        var bold = (Font)AssetDatabase.LoadAssetAtPath ("Assets/Fonts/NanumBarunGothicBold.ttf", typeof(Font));
        var bold_small = (Font)AssetDatabase.LoadAssetAtPath ("Assets/Fonts/NanumBarunGothicBold.ttf", typeof(Font));
        var warning = (Font)AssetDatabase.LoadAssetAtPath ("Assets/Fonts/NanumBarunGothic.ttf", typeof(Font));
        var skin = GUI.skin;
