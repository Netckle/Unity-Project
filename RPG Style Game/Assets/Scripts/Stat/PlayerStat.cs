...
public class PlayerStat : MonoBehaviour
{
    ...
    public void DamagedByEnemy(int _enemy_attack)
    {
        ...
        floating_text_trigger.TriggerFloatingText(this.transform.position, 100, damage.ToString(), Color.red, 25);
    ...
    void Update()
    {
        if (current_exp >= need_exp[character_level])
        {
            ...
            floating_text_trigger.TriggerFloatingText(this.transform.position, 100, "레벨 업", Color.green, 25);
        }
    }
}
